---@class DefaultTakeBurnIn_C : ULevelSequenceBurnIn
...
---@field public Slate string
---@field public TakeNumber string
---@field public Time string
local DefaultTakeBurnIn_C = {}

function DefaultTakeBurnIn_C:CacheData() end

---@return string
function DefaultTakeBurnIn_C:Get_BottomRight_Text_0() end

---@return string
function DefaultTakeBurnIn_C:Get_BottomCenter_Text_0() end

---@return string
function DefaultTakeBurnIn_C:Get_BottomLeft_Text_0() end

---@return string
function DefaultTakeBurnIn_C:Get_TopRight_Text_0() end

---@return string
function DefaultTakeBurnIn_C:Get_TopCenter_Text_0() end

---@return string
function DefaultTakeBurnIn_C:Get_TopLeft_Text_0() end

---Get the settings class to use for this burn in
---@return TSubclassOf_ULevelSequenceBurnInInitSettings_
function DefaultTakeBurnIn_C:GetSettingsClass() end

---Called after the underlying slate widget is constructed.  Depending on how the slate object is used
---this event may be called multiple times due to adding and removing from the hierarchy.
---If you need a true called-once-when-created event, use OnInitialized.
function DefaultTakeBurnIn_C:Construct() end

---Called when this burn in is receiving its settings
---@param InSettings UObject
function DefaultTakeBurnIn_C:SetSettings(InSettings) end

---Ticks this widget.  Override in derived classes, but always call the parent implementation.
---@param MyGeometry FGeometry
---@param InDeltaTime number
function DefaultTakeBurnIn_C:Tick(MyGeometry, InDeltaTime) end
